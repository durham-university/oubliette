RSpec.shared_examples "model_common" do
  ...
  let( :obj ) { obj_class.from_json(json, user) }
  ...
  describe "::find" do
    it "fetches and returns a new object" do
      ...
      new_obj = obj_class.find('5b/53/d8/08/5b53d808-2ab0-4966-85d2-7892fc033252', user)
    ...
    it "raises error when not found" do
      ...
      expect {
        obj_class.find('5b/53/d8/08/5b53d808-2ab0-4966-85d2-7892fc033252', user)
  ...
  describe "::try_find" do
    it "finds the object when it exists" do
      expect(obj_class).to receive(:get).and_return(OpenStruct.new(body: json_s, code: 200))
      new_obj = obj_class.try_find('5b/53/d8/08/5b53d808-2ab0-4966-85d2-7892fc033252', user)
      expect(new_obj).to be_a obj_class
    end
