module Oubliette
  class PreservedFilesController < Oubliette::ApplicationController
    ...
    private
      ...
      def queue_post_ingestion_job
        @resource.queue_channel(Oubliette::PostIngestionJob.new_channel(resource: @resource))
      end
      
      def create_reply(success, post=true)
        queue_post_ingestion_job if post
        super(success)
      end
